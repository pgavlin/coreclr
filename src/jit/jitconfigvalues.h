...
CONFIG_INTEGER(JitDoDataflowCSE, W("JitDoDataflowCSE"), 1)     // Perform dataflow-based CSE
CONFIG_INTEGER(JitDoDominatorCSE, W("JitDoDominatorCSE"), 0)   // Perform dominator-based CSE
